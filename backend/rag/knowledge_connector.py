"""
Local Organizational Knowledge Connector (RAG)
==============================================
Indexes, chunks, and semantically searches confidential on-premise
industrial documents (SOPs, manuals, inspection reports) using
local vector embeddings (all-MiniLM-L6-v2) and ChromaDB.
"""
