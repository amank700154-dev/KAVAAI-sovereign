...
=========================================
Parses confidential industrial documents (PDFs, scans, diagrams, images):
1. Detects document layout and scanned pages.
2. Performs on-premise local OCR extraction via Tesseract.
3. Conducts multimodal visual analysis via local vision models (qwen2.5vl:7b).
"""
